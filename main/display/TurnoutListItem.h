...
public:
  ...
  TurnoutListItem(lv_obj_t *parent, size_t index, int turnoutId, std::string name, bool thrown): parentObj(parent), index(index), turnoutId(turnoutId), name(std::move(name)), thrown(thrown){
